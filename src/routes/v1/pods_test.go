	...
	cases := map[string]struct {
		...
		"ShouldSucceedGettingPods": {
			...
			want: want{
				...
				response:   map[string]interface{}{"pods": []interface{}{map[string]interface{}{"containerName": pod1}, map[string]interface{}{"containerName": pod2}}, "count": 2},
			},
		},
		"ShouldNotGetPods": {
			args: args{
			...
			want: want{
				statusCode: http.StatusOK,
				response:   map[string]interface{}{"count": 0, "pods": interface{}(nil)},
			},
		},
